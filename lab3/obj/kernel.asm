...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	36e040ef          	jal	ra,ffffffffc02043b8 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	39a58593          	addi	a1,a1,922 # ffffffffc02043e8 <etext+0x6>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	3b250513          	addi	a0,a0,946 # ffffffffc0204408 <etext+0x26>
...
ffffffffc020006e:	61a030ef          	jal	ra,ffffffffc0203688 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	659030ef          	jal	ra,ffffffffc0203f06 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	623030ef          	jal	ra,ffffffffc0203f06 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	30c50513          	addi	a0,a0,780 # ffffffffc0204410 <etext+0x2e>
void print_kerninfo(void) {
...
ffffffffc020011e:	31650513          	addi	a0,a0,790 # ffffffffc0204430 <etext+0x4e>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2bc58593          	addi	a1,a1,700 # ffffffffc02043e2 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	32250513          	addi	a0,a0,802 # ffffffffc0204450 <etext+0x6e>
...
ffffffffc0200146:	32e50513          	addi	a0,a0,814 # ffffffffc0204470 <etext+0x8e>
...
ffffffffc020015a:	33a50513          	addi	a0,a0,826 # ffffffffc0204490 <etext+0xae>
...
ffffffffc0200188:	32c50513          	addi	a0,a0,812 # ffffffffc02044b0 <etext+0xce>
}
...
ffffffffc0200196:	34e60613          	addi	a2,a2,846 # ffffffffc02044e0 <etext+0xfe>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	35a50513          	addi	a0,a0,858 # ffffffffc02044f8 <etext+0x116>
void print_stackframe(void) {
...
ffffffffc02001b2:	36260613          	addi	a2,a2,866 # ffffffffc0204510 <etext+0x12e>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	37a58593          	addi	a1,a1,890 # ffffffffc0204530 <etext+0x14e>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	37a50513          	addi	a0,a0,890 # ffffffffc0204538 <etext+0x156>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	37c60613          	addi	a2,a2,892 # ffffffffc0204548 <etext+0x166>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	39c58593          	addi	a1,a1,924 # ffffffffc0204570 <etext+0x18e>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	35c50513          	addi	a0,a0,860 # ffffffffc0204538 <etext+0x156>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	39860613          	addi	a2,a2,920 # ffffffffc0204580 <etext+0x19e>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3b058593          	addi	a1,a1,944 # ffffffffc02045a0 <etext+0x1be>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	34050513          	addi	a0,a0,832 # ffffffffc0204538 <etext+0x156>
...
ffffffffc0200236:	37e50513          	addi	a0,a0,894 # ffffffffc02045b0 <etext+0x1ce>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	38450513          	addi	a0,a0,900 # ffffffffc02045d8 <etext+0x1f6>
...
ffffffffc020027e:	38648493          	addi	s1,s1,902 # ffffffffc0204600 <etext+0x21e>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	384b0b13          	addi	s6,s6,900 # ffffffffc0204608 <etext+0x226>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	2a4a0a13          	addi	s4,s4,676 # ffffffffc0204530 <etext+0x14e>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7f1030ef          	jal	ra,ffffffffc0204288 <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0c8040ef          	jal	ra,ffffffffc0204384 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0b4040ef          	jal	ra,ffffffffc0204384 <strcmp>
...
ffffffffc020030e:	094040ef          	jal	ra,ffffffffc02043a2 <strchr>
...
ffffffffc020034c:	056040ef          	jal	ra,ffffffffc02043a2 <strchr>
...
ffffffffc020036a:	2c250513          	addi	a0,a0,706 # ffffffffc0204628 <etext+0x246>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	713030ef          	jal	ra,ffffffffc02043ca <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	6ef030ef          	jal	ra,ffffffffc02043ca <memcpy>
    return 0;
}
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7180306f          	j	ffffffffc0203c60 <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0200b6e:	66e5b583          	ld	a1,1646(a1) # ffffffffc02061d8 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	66a63603          	ld	a2,1642(a2) # ffffffffc02061e0 <nbase>
...
ffffffffc0201722:	abab3b03          	ld	s6,-1350(s6) # ffffffffc02061d8 <error_string+0x38>
...
ffffffffc0201760:	459020ef          	jal	ra,ffffffffc02043b8 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	a0cb3b03          	ld	s6,-1524(s6) # ffffffffc02061d8 <error_string+0x38>
...
ffffffffc0201802:	3b7020ef          	jal	ra,ffffffffc02043b8 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02019f8:	7e443403          	ld	s0,2020(s0) # ffffffffc02061d8 <error_string+0x38>
...
ffffffffc0201dfe:	3decbc83          	ld	s9,990(s9) # ffffffffc02061d8 <error_string+0x38>
...
ffffffffc0201f60:	412020ef          	jal	ra,ffffffffc0204372 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	418020ef          	jal	ra,ffffffffc0204384 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	396020ef          	jal	ra,ffffffffc020433c <strlen>
...
ffffffffc02027a4:	a386b683          	ld	a3,-1480(a3) # ffffffffc02061d8 <error_string+0x38>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	3f8010ef          	jal	ra,ffffffffc0203d2e <swapfs_init>
...
ffffffffc02029ec:	2e1000ef          	jal	ra,ffffffffc02034cc <mm_create>
...
ffffffffc0202a20:	2f5000ef          	jal	ra,ffffffffc0203514 <vma_create>
...
ffffffffc0202a2c:	357000ef          	jal	ra,ffffffffc0203582 <insert_vma_struct>
...
ffffffffc0202ba0:	644c0c13          	addi	s8,s8,1604 # ffffffffc02061e0 <nbase>
...
ffffffffc0202c36:	21d000ef          	jal	ra,ffffffffc0203652 <mm_destroy>
...
ffffffffc0203040:	5c1000ef          	jal	ra,ffffffffc0203e00 <swapfs_write>
...
ffffffffc02030de:	489000ef          	jal	ra,ffffffffc0203d66 <swapfs_read>
...
ffffffffc020321c:	09400593          	li	a1,148
...
ffffffffc020323c:	0ab00593          	li	a1,171
...
ffffffffc020325c:	0a900593          	li	a1,169
...
ffffffffc020327c:	0a800593          	li	a1,168
...
ffffffffc020329c:	0a600593          	li	a1,166
...
ffffffffc02032bc:	0a400593          	li	a1,164
...
ffffffffc02032dc:	0a200593          	li	a1,162
...
ffffffffc02032fc:	0a000593          	li	a1,160
...
ffffffffc020331c:	09e00593          	li	a1,158
...
ffffffffc020333c:	09c00593          	li	a1,156
...
ffffffffc020335c:	09a00593          	li	a1,154
...
ffffffffc020337c:	09800593          	li	a1,152
...
ffffffffc020339c:	09600593          	li	a1,150
...
ffffffffc02033ae:	ec26                	sd	s1,24(sp)
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02033b0:	7504                	ld	s1,40(a0)
{
ffffffffc02033b2:	f406                	sd	ra,40(sp)
ffffffffc02033b4:	f022                	sd	s0,32(sp)
ffffffffc02033b6:	e84a                	sd	s2,16(sp)
ffffffffc02033b8:	e44e                	sd	s3,8(sp)
         assert(head != NULL);
ffffffffc02033ba:	c0bd                	beqz	s1,ffffffffc0203420 <_clock_swap_out_victim+0x74>
     assert(in_tick==0);
ffffffffc02033bc:	e251                	bnez	a2,ffffffffc0203440 <_clock_swap_out_victim+0x94>
        while(curr_ptr==head){
ffffffffc02033be:	0000e417          	auipc	s0,0xe
ffffffffc02033c2:	19a40413          	addi	s0,s0,410 # ffffffffc0211558 <curr_ptr>
ffffffffc02033c6:	89ae                	mv	s3,a1
ffffffffc02033c8:	600c                	ld	a1,0(s0)
        cprintf("curr_ptr 0xffffffff%x\n",curr_ptr);
ffffffffc02033ca:	00002917          	auipc	s2,0x2
ffffffffc02033ce:	7fe90913          	addi	s2,s2,2046 # ffffffffc0205bc8 <default_pmm_manager+0xaa0>
        while(curr_ptr==head){
ffffffffc02033d2:	00b48f63          	beq	s1,a1,ffffffffc02033f0 <_clock_swap_out_victim+0x44>
        cprintf("curr_ptr 0xffffffff%x\n",curr_ptr);
ffffffffc02033d6:	854a                	mv	a0,s2
ffffffffc02033d8:	ce3fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        tmp = le2page(curr_ptr,pra_page_link);
ffffffffc02033dc:	601c                	ld	a5,0(s0)
        if(tmp->visited == 0){
ffffffffc02033de:	fe07b703          	ld	a4,-32(a5)
ffffffffc02033e2:	cf11                	beqz	a4,ffffffffc02033fe <_clock_swap_out_victim+0x52>
            curr_ptr = curr_ptr->next;
ffffffffc02033e4:	678c                	ld	a1,8(a5)
            tmp->visited = 0;
ffffffffc02033e6:	fe07b023          	sd	zero,-32(a5)
            curr_ptr = curr_ptr->next;
ffffffffc02033ea:	e00c                	sd	a1,0(s0)
        while(curr_ptr==head){
ffffffffc02033ec:	feb495e3          	bne	s1,a1,ffffffffc02033d6 <_clock_swap_out_victim+0x2a>
    		curr_ptr = curr_ptr->next;
ffffffffc02033f0:	648c                	ld	a1,8(s1)
            cprintf("curr_ptr 0xffffffff%x\n",curr_ptr);
ffffffffc02033f2:	854a                	mv	a0,s2
    		curr_ptr = curr_ptr->next;
ffffffffc02033f4:	e00c                	sd	a1,0(s0)
            cprintf("curr_ptr 0xffffffff%x\n",curr_ptr);
ffffffffc02033f6:	cc5fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        while(curr_ptr==head){
ffffffffc02033fa:	600c                	ld	a1,0(s0)
ffffffffc02033fc:	bfd9                	j	ffffffffc02033d2 <_clock_swap_out_victim+0x26>
            curr_ptr = curr_ptr->next;
ffffffffc02033fe:	6798                	ld	a4,8(a5)
    __list_del(listelm->prev, listelm->next);
ffffffffc0203400:	6394                	ld	a3,0(a5)
}
ffffffffc0203402:	70a2                	ld	ra,40(sp)
            curr_ptr = curr_ptr->next;
ffffffffc0203404:	e018                	sd	a4,0(s0)
    prev->next = next;
ffffffffc0203406:	e698                	sd	a4,8(a3)
}
ffffffffc0203408:	7402                	ld	s0,32(sp)
    next->prev = prev;
ffffffffc020340a:	e314                	sd	a3,0(a4)
        tmp = le2page(curr_ptr,pra_page_link);
ffffffffc020340c:	fd078793          	addi	a5,a5,-48
            *ptr_page = tmp;
ffffffffc0203410:	00f9b023          	sd	a5,0(s3)
}
...
ffffffffc0203424:	78868693          	addi	a3,a3,1928 # ffffffffc0205ba8 <default_pmm_manager+0xa80>
ffffffffc0203428:	00002617          	auipc	a2,0x2
ffffffffc020342c:	95060613          	addi	a2,a2,-1712 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203430:	04b00593          	li	a1,75
ffffffffc0203434:	00002517          	auipc	a0,0x2
ffffffffc0203438:	71450513          	addi	a0,a0,1812 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020343c:	f39fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc0203440:	00002697          	auipc	a3,0x2
ffffffffc0203444:	77868693          	addi	a3,a3,1912 # ffffffffc0205bb8 <default_pmm_manager+0xa90>
ffffffffc0203448:	00002617          	auipc	a2,0x2
ffffffffc020344c:	93060613          	addi	a2,a2,-1744 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203450:	04c00593          	li	a1,76
ffffffffc0203454:	00002517          	auipc	a0,0x2
ffffffffc0203458:	6f450513          	addi	a0,a0,1780 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020345c:	f19fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203460 <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203460:	0000e797          	auipc	a5,0xe
ffffffffc0203464:	0f87b783          	ld	a5,248(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc0203468:	cf91                	beqz	a5,ffffffffc0203484 <_clock_map_swappable+0x24>
    list_add(head->prev, entry);
ffffffffc020346a:	751c                	ld	a5,40(a0)
ffffffffc020346c:	03060713          	addi	a4,a2,48
}
ffffffffc0203470:	4501                	li	a0,0
    list_add(head->prev, entry);
ffffffffc0203472:	639c                	ld	a5,0(a5)
    __list_add(elm, listelm, listelm->next);
ffffffffc0203474:	6794                	ld	a3,8(a5)
    prev->next = next->prev = elm;
ffffffffc0203476:	e298                	sd	a4,0(a3)
ffffffffc0203478:	e798                	sd	a4,8(a5)
    elm->prev = prev;
ffffffffc020347a:	fa1c                	sd	a5,48(a2)
    page->visited = 1;
ffffffffc020347c:	4785                	li	a5,1
    elm->next = next;
ffffffffc020347e:	fe14                	sd	a3,56(a2)
ffffffffc0203480:	ea1c                	sd	a5,16(a2)
}
...
ffffffffc020348a:	75a68693          	addi	a3,a3,1882 # ffffffffc0205be0 <default_pmm_manager+0xab8>
ffffffffc020348e:	00002617          	auipc	a2,0x2
ffffffffc0203492:	8ea60613          	addi	a2,a2,-1814 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203496:	03700593          	li	a1,55
ffffffffc020349a:	00002517          	auipc	a0,0x2
ffffffffc020349e:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205b48 <default_pmm_manager+0xa20>
{
ffffffffc02034a2:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034a4:	ed1fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034a8 <check_vma_overlap.part.0>:
}
...
ffffffffc02034a8:	1141                	addi	sp,sp,-16
    assert(prev->vm_start < prev->vm_end);
    assert(prev->vm_end <= next->vm_start);
    assert(next->vm_start < next->vm_end);
ffffffffc02034aa:	00002697          	auipc	a3,0x2
ffffffffc02034ae:	77668693          	addi	a3,a3,1910 # ffffffffc0205c20 <default_pmm_manager+0xaf8>
ffffffffc02034b2:	00002617          	auipc	a2,0x2
ffffffffc02034b6:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204d78 <commands+0x738>
ffffffffc02034ba:	07d00593          	li	a1,125
ffffffffc02034be:	00002517          	auipc	a0,0x2
ffffffffc02034c2:	78250513          	addi	a0,a0,1922 # ffffffffc0205c40 <default_pmm_manager+0xb18>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02034c6:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02034c8:	eadfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034cc <mm_create>:
mm_create(void) {
ffffffffc02034cc:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034ce:	03000513          	li	a0,48
mm_create(void) {
ffffffffc02034d2:	e022                	sd	s0,0(sp)
ffffffffc02034d4:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034d6:	aa2ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02034da:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02034dc:	c105                	beqz	a0,ffffffffc02034fc <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02034de:	e408                	sd	a0,8(s0)
ffffffffc02034e0:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02034e2:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02034e6:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02034ea:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034ee:	0000e797          	auipc	a5,0xe
ffffffffc02034f2:	0627a783          	lw	a5,98(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034f6:	eb81                	bnez	a5,ffffffffc0203506 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02034f8:	02053423          	sd	zero,40(a0)
}
ffffffffc02034fc:	60a2                	ld	ra,8(sp)
ffffffffc02034fe:	8522                	mv	a0,s0
ffffffffc0203500:	6402                	ld	s0,0(sp)
ffffffffc0203502:	0141                	addi	sp,sp,16
ffffffffc0203504:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203506:	a7fff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc0203514 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203514:	1101                	addi	sp,sp,-32
ffffffffc0203516:	e04a                	sd	s2,0(sp)
ffffffffc0203518:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020351a:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020351e:	e822                	sd	s0,16(sp)
ffffffffc0203520:	e426                	sd	s1,8(sp)
ffffffffc0203522:	ec06                	sd	ra,24(sp)
ffffffffc0203524:	84ae                	mv	s1,a1
ffffffffc0203526:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203528:	a50ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc020352c:	c509                	beqz	a0,ffffffffc0203536 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc020352e:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203532:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203534:	ed00                	sd	s0,24(a0)
}
ffffffffc0203536:	60e2                	ld	ra,24(sp)
ffffffffc0203538:	6442                	ld	s0,16(sp)
ffffffffc020353a:	64a2                	ld	s1,8(sp)
ffffffffc020353c:	6902                	ld	s2,0(sp)
ffffffffc020353e:	6105                	addi	sp,sp,32
ffffffffc0203540:	8082                	ret

ffffffffc0203542 <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc0203542:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc0203544:	c505                	beqz	a0,ffffffffc020356c <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc0203546:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203548:	c501                	beqz	a0,ffffffffc0203550 <find_vma+0xe>
ffffffffc020354a:	651c                	ld	a5,8(a0)
ffffffffc020354c:	02f5f263          	bgeu	a1,a5,ffffffffc0203570 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203550:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc0203552:	00f68d63          	beq	a3,a5,ffffffffc020356c <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203556:	fe87b703          	ld	a4,-24(a5)
ffffffffc020355a:	00e5e663          	bltu	a1,a4,ffffffffc0203566 <find_vma+0x24>
ffffffffc020355e:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203562:	00e5ec63          	bltu	a1,a4,ffffffffc020357a <find_vma+0x38>
ffffffffc0203566:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203568:	fef697e3          	bne	a3,a5,ffffffffc0203556 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc020356c:	4501                	li	a0,0
}
ffffffffc020356e:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203570:	691c                	ld	a5,16(a0)
ffffffffc0203572:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203550 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203576:	ea88                	sd	a0,16(a3)
ffffffffc0203578:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc020357a:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc020357e:	ea88                	sd	a0,16(a3)
ffffffffc0203580:	8082                	ret

ffffffffc0203582 <insert_vma_struct>:
...
ffffffffc0203582:	6590                	ld	a2,8(a1)
ffffffffc0203584:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc0203588:	1141                	addi	sp,sp,-16
ffffffffc020358a:	e406                	sd	ra,8(sp)
ffffffffc020358c:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc020358e:	01066763          	bltu	a2,a6,ffffffffc020359c <insert_vma_struct+0x1a>
ffffffffc0203592:	a085                	j	ffffffffc02035f2 <insert_vma_struct+0x70>
...
ffffffffc0203594:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203598:	04e66863          	bltu	a2,a4,ffffffffc02035e8 <insert_vma_struct+0x66>
ffffffffc020359c:	86be                	mv	a3,a5
ffffffffc020359e:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02035a0:	fef51ae3          	bne	a0,a5,ffffffffc0203594 <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc02035a4:	02a68463          	beq	a3,a0,ffffffffc02035cc <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02035a8:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035ac:	fe86b883          	ld	a7,-24(a3)
ffffffffc02035b0:	08e8f163          	bgeu	a7,a4,ffffffffc0203632 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035b4:	04e66f63          	bltu	a2,a4,ffffffffc0203612 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02035b8:	00f50a63          	beq	a0,a5,ffffffffc02035cc <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc02035bc:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035c0:	05076963          	bltu	a4,a6,ffffffffc0203612 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc02035c4:	ff07b603          	ld	a2,-16(a5)
ffffffffc02035c8:	02c77363          	bgeu	a4,a2,ffffffffc02035ee <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc02035cc:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02035ce:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02035d0:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02035d4:	e390                	sd	a2,0(a5)
ffffffffc02035d6:	e690                	sd	a2,8(a3)
}
ffffffffc02035d8:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02035da:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02035dc:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02035de:	0017079b          	addiw	a5,a4,1
ffffffffc02035e2:	d11c                	sw	a5,32(a0)
}
ffffffffc02035e4:	0141                	addi	sp,sp,16
ffffffffc02035e6:	8082                	ret
    if (le_prev != list) {
ffffffffc02035e8:	fca690e3          	bne	a3,a0,ffffffffc02035a8 <insert_vma_struct+0x26>
ffffffffc02035ec:	bfd1                	j	ffffffffc02035c0 <insert_vma_struct+0x3e>
ffffffffc02035ee:	ebbff0ef          	jal	ra,ffffffffc02034a8 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035f2:	00002697          	auipc	a3,0x2
ffffffffc02035f6:	65e68693          	addi	a3,a3,1630 # ffffffffc0205c50 <default_pmm_manager+0xb28>
ffffffffc02035fa:	00001617          	auipc	a2,0x1
ffffffffc02035fe:	77e60613          	addi	a2,a2,1918 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203602:	08400593          	li	a1,132
ffffffffc0203606:	00002517          	auipc	a0,0x2
ffffffffc020360a:	63a50513          	addi	a0,a0,1594 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc020360e:	d67fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203612:	00002697          	auipc	a3,0x2
ffffffffc0203616:	67e68693          	addi	a3,a3,1662 # ffffffffc0205c90 <default_pmm_manager+0xb68>
ffffffffc020361a:	00001617          	auipc	a2,0x1
ffffffffc020361e:	75e60613          	addi	a2,a2,1886 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203622:	07c00593          	li	a1,124
ffffffffc0203626:	00002517          	auipc	a0,0x2
ffffffffc020362a:	61a50513          	addi	a0,a0,1562 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc020362e:	d47fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203632:	00002697          	auipc	a3,0x2
ffffffffc0203636:	63e68693          	addi	a3,a3,1598 # ffffffffc0205c70 <default_pmm_manager+0xb48>
ffffffffc020363a:	00001617          	auipc	a2,0x1
ffffffffc020363e:	73e60613          	addi	a2,a2,1854 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203642:	07b00593          	li	a1,123
ffffffffc0203646:	00002517          	auipc	a0,0x2
ffffffffc020364a:	5fa50513          	addi	a0,a0,1530 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc020364e:	d27fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203652 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc0203652:	1141                	addi	sp,sp,-16
ffffffffc0203654:	e022                	sd	s0,0(sp)
ffffffffc0203656:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203658:	6508                	ld	a0,8(a0)
ffffffffc020365a:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc020365c:	00a40e63          	beq	s0,a0,ffffffffc0203678 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203660:	6118                	ld	a4,0(a0)
ffffffffc0203662:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203664:	03000593          	li	a1,48
ffffffffc0203668:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020366a:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020366c:	e398                	sd	a4,0(a5)
ffffffffc020366e:	9c4ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203672:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203674:	fea416e3          	bne	s0,a0,ffffffffc0203660 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203678:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc020367a:	6402                	ld	s0,0(sp)
...
ffffffffc0203682:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203684:	9aeff06f          	j	ffffffffc0202832 <kfree>

ffffffffc0203688 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203688:	715d                	addi	sp,sp,-80
ffffffffc020368a:	e486                	sd	ra,72(sp)
ffffffffc020368c:	f44e                	sd	s3,40(sp)
ffffffffc020368e:	f052                	sd	s4,32(sp)
ffffffffc0203690:	e0a2                	sd	s0,64(sp)
ffffffffc0203692:	fc26                	sd	s1,56(sp)
ffffffffc0203694:	f84a                	sd	s2,48(sp)
ffffffffc0203696:	ec56                	sd	s5,24(sp)
ffffffffc0203698:	e85a                	sd	s6,16(sp)
ffffffffc020369a:	e45e                	sd	s7,8(sp)
}
...
ffffffffc020369c:	ff7fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02036a0:	89aa                	mv	s3,a0
...
ffffffffc02036a6:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02036a8:	03000513          	li	a0,48
ffffffffc02036ac:	8ccff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc02036b0:	56050863          	beqz	a0,ffffffffc0203c20 <vmm_init+0x598>
    elm->prev = elm->next = elm;
...
ffffffffc02036c0:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02036c4:	0000e797          	auipc	a5,0xe
ffffffffc02036c8:	e8c7a783          	lw	a5,-372(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02036cc:	84aa                	mv	s1,a0
ffffffffc02036ce:	e7b9                	bnez	a5,ffffffffc020371c <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc02036d0:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc02036d4:	03200413          	li	s0,50
ffffffffc02036d8:	a811                	j	ffffffffc02036ec <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02036da:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02036dc:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02036de:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02036e2:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036e4:	8526                	mv	a0,s1
ffffffffc02036e6:	e9dff0ef          	jal	ra,ffffffffc0203582 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02036ea:	cc05                	beqz	s0,ffffffffc0203722 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02036ec:	03000513          	li	a0,48
ffffffffc02036f0:	888ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036f4:	85aa                	mv	a1,a0
ffffffffc02036f6:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036fa:	f165                	bnez	a0,ffffffffc02036da <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02036fc:	00002697          	auipc	a3,0x2
ffffffffc0203700:	15c68693          	addi	a3,a3,348 # ffffffffc0205858 <default_pmm_manager+0x730>
ffffffffc0203704:	00001617          	auipc	a2,0x1
ffffffffc0203708:	67460613          	addi	a2,a2,1652 # ffffffffc0204d78 <commands+0x738>
ffffffffc020370c:	0ce00593          	li	a1,206
ffffffffc0203710:	00002517          	auipc	a0,0x2
ffffffffc0203714:	53050513          	addi	a0,a0,1328 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203718:	c5dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020371c:	869ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203720:	bf55                	j	ffffffffc02036d4 <vmm_init+0x4c>
ffffffffc0203722:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203726:	1f900913          	li	s2,505
ffffffffc020372a:	a819                	j	ffffffffc0203740 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc020372c:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc020372e:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203730:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203734:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203736:	8526                	mv	a0,s1
ffffffffc0203738:	e4bff0ef          	jal	ra,ffffffffc0203582 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020373c:	03240a63          	beq	s0,s2,ffffffffc0203770 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203740:	03000513          	li	a0,48
ffffffffc0203744:	834ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203748:	85aa                	mv	a1,a0
ffffffffc020374a:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc020374e:	fd79                	bnez	a0,ffffffffc020372c <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc0203750:	00002697          	auipc	a3,0x2
ffffffffc0203754:	10868693          	addi	a3,a3,264 # ffffffffc0205858 <default_pmm_manager+0x730>
ffffffffc0203758:	00001617          	auipc	a2,0x1
ffffffffc020375c:	62060613          	addi	a2,a2,1568 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203760:	0d400593          	li	a1,212
ffffffffc0203764:	00002517          	auipc	a0,0x2
ffffffffc0203768:	4dc50513          	addi	a0,a0,1244 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc020376c:	c09fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203770:	649c                	ld	a5,8(s1)
ffffffffc0203772:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203774:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203778:	2ef48463          	beq	s1,a5,ffffffffc0203a60 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc020377c:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203780:	ffe70693          	addi	a3,a4,-2
ffffffffc0203784:	26d61e63          	bne	a2,a3,ffffffffc0203a00 <vmm_init+0x378>
ffffffffc0203788:	ff07b683          	ld	a3,-16(a5)
ffffffffc020378c:	26e69a63          	bne	a3,a4,ffffffffc0203a00 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203790:	0715                	addi	a4,a4,5
ffffffffc0203792:	679c                	ld	a5,8(a5)
ffffffffc0203794:	feb712e3          	bne	a4,a1,ffffffffc0203778 <vmm_init+0xf0>
ffffffffc0203798:	4b1d                	li	s6,7
ffffffffc020379a:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020379c:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc02037a0:	85a2                	mv	a1,s0
ffffffffc02037a2:	8526                	mv	a0,s1
ffffffffc02037a4:	d9fff0ef          	jal	ra,ffffffffc0203542 <find_vma>
ffffffffc02037a8:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc02037aa:	2c050b63          	beqz	a0,ffffffffc0203a80 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02037ae:	00140593          	addi	a1,s0,1
ffffffffc02037b2:	8526                	mv	a0,s1
ffffffffc02037b4:	d8fff0ef          	jal	ra,ffffffffc0203542 <find_vma>
ffffffffc02037b8:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02037ba:	2e050363          	beqz	a0,ffffffffc0203aa0 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02037be:	85da                	mv	a1,s6
ffffffffc02037c0:	8526                	mv	a0,s1
ffffffffc02037c2:	d81ff0ef          	jal	ra,ffffffffc0203542 <find_vma>
        assert(vma3 == NULL);
ffffffffc02037c6:	2e051d63          	bnez	a0,ffffffffc0203ac0 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02037ca:	00340593          	addi	a1,s0,3
ffffffffc02037ce:	8526                	mv	a0,s1
ffffffffc02037d0:	d73ff0ef          	jal	ra,ffffffffc0203542 <find_vma>
        assert(vma4 == NULL);
ffffffffc02037d4:	30051663          	bnez	a0,ffffffffc0203ae0 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02037d8:	00440593          	addi	a1,s0,4
ffffffffc02037dc:	8526                	mv	a0,s1
ffffffffc02037de:	d65ff0ef          	jal	ra,ffffffffc0203542 <find_vma>
        assert(vma5 == NULL);
ffffffffc02037e2:	30051f63          	bnez	a0,ffffffffc0203b00 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02037e6:	00893783          	ld	a5,8(s2)
ffffffffc02037ea:	24879b63          	bne	a5,s0,ffffffffc0203a40 <vmm_init+0x3b8>
ffffffffc02037ee:	01093783          	ld	a5,16(s2)
ffffffffc02037f2:	25679763          	bne	a5,s6,ffffffffc0203a40 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02037f6:	008ab783          	ld	a5,8(s5)
ffffffffc02037fa:	22879363          	bne	a5,s0,ffffffffc0203a20 <vmm_init+0x398>
ffffffffc02037fe:	010ab783          	ld	a5,16(s5)
ffffffffc0203802:	21679f63          	bne	a5,s6,ffffffffc0203a20 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203806:	0415                	addi	s0,s0,5
ffffffffc0203808:	0b15                	addi	s6,s6,5
ffffffffc020380a:	f9741be3          	bne	s0,s7,ffffffffc02037a0 <vmm_init+0x118>
ffffffffc020380e:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203810:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc0203812:	85a2                	mv	a1,s0
ffffffffc0203814:	8526                	mv	a0,s1
ffffffffc0203816:	d2dff0ef          	jal	ra,ffffffffc0203542 <find_vma>
ffffffffc020381a:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc020381e:	c90d                	beqz	a0,ffffffffc0203850 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203820:	6914                	ld	a3,16(a0)
ffffffffc0203822:	6510                	ld	a2,8(a0)
ffffffffc0203824:	00002517          	auipc	a0,0x2
ffffffffc0203828:	58c50513          	addi	a0,a0,1420 # ffffffffc0205db0 <default_pmm_manager+0xc88>
ffffffffc020382c:	88ffc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203830:	00002697          	auipc	a3,0x2
ffffffffc0203834:	5a868693          	addi	a3,a3,1448 # ffffffffc0205dd8 <default_pmm_manager+0xcb0>
ffffffffc0203838:	00001617          	auipc	a2,0x1
ffffffffc020383c:	54060613          	addi	a2,a2,1344 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203840:	0f600593          	li	a1,246
ffffffffc0203844:	00002517          	auipc	a0,0x2
ffffffffc0203848:	3fc50513          	addi	a0,a0,1020 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc020384c:	b29fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203850:	147d                	addi	s0,s0,-1
ffffffffc0203852:	fd2410e3          	bne	s0,s2,ffffffffc0203812 <vmm_init+0x18a>
ffffffffc0203856:	a811                	j	ffffffffc020386a <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203858:	6118                	ld	a4,0(a0)
ffffffffc020385a:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020385c:	03000593          	li	a1,48
ffffffffc0203860:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203862:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203864:	e398                	sd	a4,0(a5)
ffffffffc0203866:	fcdfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020386a:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc020386c:	fea496e3          	bne	s1,a0,ffffffffc0203858 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203870:	03000593          	li	a1,48
ffffffffc0203874:	8526                	mv	a0,s1
ffffffffc0203876:	fbdfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }
...
ffffffffc020387e:	3caa1163          	bne	s4,a0,ffffffffc0203c40 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203882:	00002517          	auipc	a0,0x2
ffffffffc0203886:	59650513          	addi	a0,a0,1430 # ffffffffc0205e18 <default_pmm_manager+0xcf0>
...
ffffffffc0203892:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203894:	03000513          	li	a0,48
ffffffffc0203898:	ee1fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020389c:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc020389e:	2a050163          	beqz	a0,ffffffffc0203b40 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038a2:	0000e797          	auipc	a5,0xe
ffffffffc02038a6:	cae7a783          	lw	a5,-850(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc02038aa:	e508                	sd	a0,8(a0)
ffffffffc02038ac:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02038ae:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02038b2:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02038b6:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038ba:	14079063          	bnez	a5,ffffffffc02039fa <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc02038be:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038c2:	0000e917          	auipc	s2,0xe
ffffffffc02038c6:	c5693903          	ld	s2,-938(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc02038ca:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc02038ce:	0000e717          	auipc	a4,0xe
ffffffffc02038d2:	c8873923          	sd	s0,-878(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038d6:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02038da:	24079363          	bnez	a5,ffffffffc0203b20 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038de:	03000513          	li	a0,48
ffffffffc02038e2:	e97fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02038e6:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02038e8:	28050063          	beqz	a0,ffffffffc0203b68 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02038ec:	002007b7          	lui	a5,0x200
ffffffffc02038f0:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02038f4:	4789                	li	a5,2
...
ffffffffc02038f6:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02038f8:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038fc:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02038fe:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203902:	c81ff0ef          	jal	ra,ffffffffc0203582 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203906:	10000593          	li	a1,256
ffffffffc020390a:	8522                	mv	a0,s0
ffffffffc020390c:	c37ff0ef          	jal	ra,ffffffffc0203542 <find_vma>
ffffffffc0203910:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203914:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203918:	26aa1863          	bne	s4,a0,ffffffffc0203b88 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc020391c:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203920:	0785                	addi	a5,a5,1
ffffffffc0203922:	fee79de3          	bne	a5,a4,ffffffffc020391c <vmm_init+0x294>
        sum += i;
ffffffffc0203926:	6705                	lui	a4,0x1
ffffffffc0203928:	10000793          	li	a5,256
ffffffffc020392c:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203930:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203934:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203938:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc020393a:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc020393c:	fec79ce3          	bne	a5,a2,ffffffffc0203934 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc0203940:	26071463          	bnez	a4,ffffffffc0203ba8 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203944:	4581                	li	a1,0
ffffffffc0203946:	854a                	mv	a0,s2
ffffffffc0203948:	fd5fd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc020394c:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203950:	0000e717          	auipc	a4,0xe
ffffffffc0203954:	bd073703          	ld	a4,-1072(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203958:	078a                	slli	a5,a5,0x2
ffffffffc020395a:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc020395c:	26e7f663          	bgeu	a5,a4,ffffffffc0203bc8 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203960:	00003717          	auipc	a4,0x3
ffffffffc0203964:	88073703          	ld	a4,-1920(a4) # ffffffffc02061e0 <nbase>
ffffffffc0203968:	8f99                	sub	a5,a5,a4
ffffffffc020396a:	00379713          	slli	a4,a5,0x3
ffffffffc020396e:	97ba                	add	a5,a5,a4
ffffffffc0203970:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203972:	0000e517          	auipc	a0,0xe
ffffffffc0203976:	bb653503          	ld	a0,-1098(a0) # ffffffffc0211528 <pages>
ffffffffc020397a:	953e                	add	a0,a0,a5
ffffffffc020397c:	4585                	li	a1,1
ffffffffc020397e:	cd5fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203982:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203984:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203988:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020398c:	00a40e63          	beq	s0,a0,ffffffffc02039a8 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
...
ffffffffc02039a2:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039a4:	fea416e3          	bne	s0,a0,ffffffffc0203990 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
...
ffffffffc02039b2:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc02039b4:	0000e797          	auipc	a5,0xe
ffffffffc02039b8:	ba07b623          	sd	zero,-1108(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039bc:	cd7fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02039c0:	22a49063          	bne	s1,a0,ffffffffc0203be0 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc02039c4:	00002517          	auipc	a0,0x2
ffffffffc02039c8:	4a450513          	addi	a0,a0,1188 # ffffffffc0205e68 <default_pmm_manager+0xd40>
ffffffffc02039cc:	eeefc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039d0:	cc3fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc02039d4:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039d6:	22a99563          	bne	s3,a0,ffffffffc0203c00 <vmm_init+0x578>
}
ffffffffc02039da:	6406                	ld	s0,64(sp)
ffffffffc02039dc:	60a6                	ld	ra,72(sp)
ffffffffc02039de:	74e2                	ld	s1,56(sp)
ffffffffc02039e0:	7942                	ld	s2,48(sp)
ffffffffc02039e2:	79a2                	ld	s3,40(sp)
ffffffffc02039e4:	7a02                	ld	s4,32(sp)
ffffffffc02039e6:	6ae2                	ld	s5,24(sp)
ffffffffc02039e8:	6b42                	ld	s6,16(sp)
ffffffffc02039ea:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039ec:	00002517          	auipc	a0,0x2
ffffffffc02039f0:	49c50513          	addi	a0,a0,1180 # ffffffffc0205e88 <default_pmm_manager+0xd60>
}
ffffffffc02039f4:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039f6:	ec4fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039fa:	d8aff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02039fe:	b5d1                	j	ffffffffc02038c2 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203a00:	00002697          	auipc	a3,0x2
ffffffffc0203a04:	2c868693          	addi	a3,a3,712 # ffffffffc0205cc8 <default_pmm_manager+0xba0>
ffffffffc0203a08:	00001617          	auipc	a2,0x1
ffffffffc0203a0c:	37060613          	addi	a2,a2,880 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203a10:	0dd00593          	li	a1,221
ffffffffc0203a14:	00002517          	auipc	a0,0x2
ffffffffc0203a18:	22c50513          	addi	a0,a0,556 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203a1c:	959fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a20:	00002697          	auipc	a3,0x2
ffffffffc0203a24:	36068693          	addi	a3,a3,864 # ffffffffc0205d80 <default_pmm_manager+0xc58>
ffffffffc0203a28:	00001617          	auipc	a2,0x1
ffffffffc0203a2c:	35060613          	addi	a2,a2,848 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203a30:	0ee00593          	li	a1,238
ffffffffc0203a34:	00002517          	auipc	a0,0x2
ffffffffc0203a38:	20c50513          	addi	a0,a0,524 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203a3c:	939fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a40:	00002697          	auipc	a3,0x2
ffffffffc0203a44:	31068693          	addi	a3,a3,784 # ffffffffc0205d50 <default_pmm_manager+0xc28>
ffffffffc0203a48:	00001617          	auipc	a2,0x1
ffffffffc0203a4c:	33060613          	addi	a2,a2,816 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203a50:	0ed00593          	li	a1,237
ffffffffc0203a54:	00002517          	auipc	a0,0x2
ffffffffc0203a58:	1ec50513          	addi	a0,a0,492 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203a5c:	919fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a60:	00002697          	auipc	a3,0x2
ffffffffc0203a64:	25068693          	addi	a3,a3,592 # ffffffffc0205cb0 <default_pmm_manager+0xb88>
ffffffffc0203a68:	00001617          	auipc	a2,0x1
ffffffffc0203a6c:	31060613          	addi	a2,a2,784 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203a70:	0db00593          	li	a1,219
ffffffffc0203a74:	00002517          	auipc	a0,0x2
ffffffffc0203a78:	1cc50513          	addi	a0,a0,460 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203a7c:	8f9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a80:	00002697          	auipc	a3,0x2
ffffffffc0203a84:	28068693          	addi	a3,a3,640 # ffffffffc0205d00 <default_pmm_manager+0xbd8>
ffffffffc0203a88:	00001617          	auipc	a2,0x1
ffffffffc0203a8c:	2f060613          	addi	a2,a2,752 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203a90:	0e300593          	li	a1,227
ffffffffc0203a94:	00002517          	auipc	a0,0x2
ffffffffc0203a98:	1ac50513          	addi	a0,a0,428 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203a9c:	8d9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203aa0:	00002697          	auipc	a3,0x2
ffffffffc0203aa4:	27068693          	addi	a3,a3,624 # ffffffffc0205d10 <default_pmm_manager+0xbe8>
ffffffffc0203aa8:	00001617          	auipc	a2,0x1
ffffffffc0203aac:	2d060613          	addi	a2,a2,720 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203ab0:	0e500593          	li	a1,229
ffffffffc0203ab4:	00002517          	auipc	a0,0x2
ffffffffc0203ab8:	18c50513          	addi	a0,a0,396 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203abc:	8b9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ac0:	00002697          	auipc	a3,0x2
ffffffffc0203ac4:	26068693          	addi	a3,a3,608 # ffffffffc0205d20 <default_pmm_manager+0xbf8>
ffffffffc0203ac8:	00001617          	auipc	a2,0x1
ffffffffc0203acc:	2b060613          	addi	a2,a2,688 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203ad0:	0e700593          	li	a1,231
ffffffffc0203ad4:	00002517          	auipc	a0,0x2
ffffffffc0203ad8:	16c50513          	addi	a0,a0,364 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203adc:	899fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ae0:	00002697          	auipc	a3,0x2
ffffffffc0203ae4:	25068693          	addi	a3,a3,592 # ffffffffc0205d30 <default_pmm_manager+0xc08>
ffffffffc0203ae8:	00001617          	auipc	a2,0x1
ffffffffc0203aec:	29060613          	addi	a2,a2,656 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203af0:	0e900593          	li	a1,233
ffffffffc0203af4:	00002517          	auipc	a0,0x2
ffffffffc0203af8:	14c50513          	addi	a0,a0,332 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203afc:	879fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203b00:	00002697          	auipc	a3,0x2
ffffffffc0203b04:	24068693          	addi	a3,a3,576 # ffffffffc0205d40 <default_pmm_manager+0xc18>
ffffffffc0203b08:	00001617          	auipc	a2,0x1
ffffffffc0203b0c:	27060613          	addi	a2,a2,624 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203b10:	0eb00593          	li	a1,235
ffffffffc0203b14:	00002517          	auipc	a0,0x2
ffffffffc0203b18:	12c50513          	addi	a0,a0,300 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203b1c:	859fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b20:	00002697          	auipc	a3,0x2
ffffffffc0203b24:	d2868693          	addi	a3,a3,-728 # ffffffffc0205848 <default_pmm_manager+0x720>
ffffffffc0203b28:	00001617          	auipc	a2,0x1
ffffffffc0203b2c:	25060613          	addi	a2,a2,592 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203b30:	10d00593          	li	a1,269
ffffffffc0203b34:	00002517          	auipc	a0,0x2
ffffffffc0203b38:	10c50513          	addi	a0,a0,268 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203b3c:	839fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b40:	00002697          	auipc	a3,0x2
ffffffffc0203b44:	36068693          	addi	a3,a3,864 # ffffffffc0205ea0 <default_pmm_manager+0xd78>
ffffffffc0203b48:	00001617          	auipc	a2,0x1
ffffffffc0203b4c:	23060613          	addi	a2,a2,560 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203b50:	10a00593          	li	a1,266
ffffffffc0203b54:	00002517          	auipc	a0,0x2
ffffffffc0203b58:	0ec50513          	addi	a0,a0,236 # ffffffffc0205c40 <default_pmm_manager+0xb18>
    check_mm_struct = mm_create();
ffffffffc0203b5c:	0000e797          	auipc	a5,0xe
ffffffffc0203b60:	a007b223          	sd	zero,-1532(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b64:	811fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b68:	00002697          	auipc	a3,0x2
ffffffffc0203b6c:	cf068693          	addi	a3,a3,-784 # ffffffffc0205858 <default_pmm_manager+0x730>
ffffffffc0203b70:	00001617          	auipc	a2,0x1
ffffffffc0203b74:	20860613          	addi	a2,a2,520 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203b78:	11100593          	li	a1,273
ffffffffc0203b7c:	00002517          	auipc	a0,0x2
ffffffffc0203b80:	0c450513          	addi	a0,a0,196 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203b84:	ff0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b88:	00002697          	auipc	a3,0x2
ffffffffc0203b8c:	2b068693          	addi	a3,a3,688 # ffffffffc0205e38 <default_pmm_manager+0xd10>
ffffffffc0203b90:	00001617          	auipc	a2,0x1
ffffffffc0203b94:	1e860613          	addi	a2,a2,488 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203b98:	11600593          	li	a1,278
ffffffffc0203b9c:	00002517          	auipc	a0,0x2
ffffffffc0203ba0:	0a450513          	addi	a0,a0,164 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203ba4:	fd0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203ba8:	00002697          	auipc	a3,0x2
ffffffffc0203bac:	2b068693          	addi	a3,a3,688 # ffffffffc0205e58 <default_pmm_manager+0xd30>
ffffffffc0203bb0:	00001617          	auipc	a2,0x1
ffffffffc0203bb4:	1c860613          	addi	a2,a2,456 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203bb8:	12000593          	li	a1,288
ffffffffc0203bbc:	00002517          	auipc	a0,0x2
ffffffffc0203bc0:	08450513          	addi	a0,a0,132 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203bc4:	fb0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203bc8:	00001617          	auipc	a2,0x1
ffffffffc0203bcc:	59860613          	addi	a2,a2,1432 # ffffffffc0205160 <default_pmm_manager+0x38>
ffffffffc0203bd0:	06500593          	li	a1,101
ffffffffc0203bd4:	00001517          	auipc	a0,0x1
ffffffffc0203bd8:	5ac50513          	addi	a0,a0,1452 # ffffffffc0205180 <default_pmm_manager+0x58>
ffffffffc0203bdc:	f98fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203be0:	00002697          	auipc	a3,0x2
ffffffffc0203be4:	21068693          	addi	a3,a3,528 # ffffffffc0205df0 <default_pmm_manager+0xcc8>
ffffffffc0203be8:	00001617          	auipc	a2,0x1
ffffffffc0203bec:	19060613          	addi	a2,a2,400 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203bf0:	12e00593          	li	a1,302
ffffffffc0203bf4:	00002517          	auipc	a0,0x2
ffffffffc0203bf8:	04c50513          	addi	a0,a0,76 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203bfc:	f78fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c00:	00002697          	auipc	a3,0x2
ffffffffc0203c04:	1f068693          	addi	a3,a3,496 # ffffffffc0205df0 <default_pmm_manager+0xcc8>
ffffffffc0203c08:	00001617          	auipc	a2,0x1
ffffffffc0203c0c:	17060613          	addi	a2,a2,368 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203c10:	0bd00593          	li	a1,189
ffffffffc0203c14:	00002517          	auipc	a0,0x2
ffffffffc0203c18:	02c50513          	addi	a0,a0,44 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203c1c:	f58fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c20:	00002697          	auipc	a3,0x2
ffffffffc0203c24:	c0068693          	addi	a3,a3,-1024 # ffffffffc0205820 <default_pmm_manager+0x6f8>
ffffffffc0203c28:	00001617          	auipc	a2,0x1
ffffffffc0203c2c:	15060613          	addi	a2,a2,336 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203c30:	0c700593          	li	a1,199
ffffffffc0203c34:	00002517          	auipc	a0,0x2
ffffffffc0203c38:	00c50513          	addi	a0,a0,12 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203c3c:	f38fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c40:	00002697          	auipc	a3,0x2
ffffffffc0203c44:	1b068693          	addi	a3,a3,432 # ffffffffc0205df0 <default_pmm_manager+0xcc8>
ffffffffc0203c48:	00001617          	auipc	a2,0x1
ffffffffc0203c4c:	13060613          	addi	a2,a2,304 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203c50:	0fb00593          	li	a1,251
ffffffffc0203c54:	00002517          	auipc	a0,0x2
ffffffffc0203c58:	fec50513          	addi	a0,a0,-20 # ffffffffc0205c40 <default_pmm_manager+0xb18>
ffffffffc0203c5c:	f18fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c60 <do_pgfault>:
...
ffffffffc0203c60:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c62:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c64:	f022                	sd	s0,32(sp)
...
ffffffffc0203c6e:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c70:	8d3ff0ef          	jal	ra,ffffffffc0203542 <find_vma>

    pgfault_num++;
ffffffffc0203c74:	0000e797          	auipc	a5,0xe
ffffffffc0203c78:	8f47a783          	lw	a5,-1804(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203c7c:	2785                	addiw	a5,a5,1
ffffffffc0203c7e:	0000e717          	auipc	a4,0xe
ffffffffc0203c82:	8ef72523          	sw	a5,-1814(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203c86:	c159                	beqz	a0,ffffffffc0203d0c <do_pgfault+0xac>
ffffffffc0203c88:	651c                	ld	a5,8(a0)
ffffffffc0203c8a:	08f46163          	bltu	s0,a5,ffffffffc0203d0c <do_pgfault+0xac>
...
ffffffffc0203c8e:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c90:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c92:	8b89                	andi	a5,a5,2
ffffffffc0203c94:	ebb1                	bnez	a5,ffffffffc0203ce8 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c96:	75fd                	lui	a1,0xfffff
...
ffffffffc0203c98:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c9a:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203c9c:	85a2                	mv	a1,s0
ffffffffc0203c9e:	4605                	li	a2,1
ffffffffc0203ca0:	a2dfd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203ca4:	610c                	ld	a1,0(a0)
ffffffffc0203ca6:	c1b9                	beqz	a1,ffffffffc0203cec <do_pgfault+0x8c>
...
ffffffffc0203cac:	8a87a783          	lw	a5,-1880(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203cb0:	c7bd                	beqz	a5,ffffffffc0203d1e <do_pgfault+0xbe>
...
ffffffffc0203cb2:	85a2                	mv	a1,s0
ffffffffc0203cb4:	0030                	addi	a2,sp,8
ffffffffc0203cb6:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203cb8:	e402                	sd	zero,8(sp)
	    swap_in(mm, addr, &page);
ffffffffc0203cba:	bf6ff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
...
ffffffffc0203cc2:	86ca                	mv	a3,s2
ffffffffc0203cc4:	8622                	mv	a2,s0
ffffffffc0203cc6:	cf1fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm, addr, page, 0); // 使这一页可以置换
ffffffffc0203cca:	6622                	ld	a2,8(sp)
ffffffffc0203ccc:	4681                	li	a3,0
ffffffffc0203cce:	85a2                	mv	a1,s0
ffffffffc0203cd0:	8526                	mv	a0,s1
ffffffffc0203cd2:	abeff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            page->pra_vaddr = addr;
...
ffffffffc0203cd8:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203cda:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203cdc:	70a2                	ld	ra,40(sp)
ffffffffc0203cde:	7402                	ld	s0,32(sp)
ffffffffc0203ce0:	64e2                	ld	s1,24(sp)
ffffffffc0203ce2:	6942                	ld	s2,16(sp)
ffffffffc0203ce4:	6145                	addi	sp,sp,48
ffffffffc0203ce6:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203ce8:	4959                	li	s2,22
ffffffffc0203cea:	b775                	j	ffffffffc0203c96 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cec:	6c88                	ld	a0,24(s1)
ffffffffc0203cee:	864a                	mv	a2,s2
ffffffffc0203cf0:	85a2                	mv	a1,s0
ffffffffc0203cf2:	9cffe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203cf6:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203cf8:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cfa:	f3ed                	bnez	a5,ffffffffc0203cdc <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203cfc:	00002517          	auipc	a0,0x2
ffffffffc0203d00:	1ec50513          	addi	a0,a0,492 # ffffffffc0205ee8 <default_pmm_manager+0xdc0>
ffffffffc0203d04:	bb6fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d08:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d0a:	bfc9                	j	ffffffffc0203cdc <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d0c:	85a2                	mv	a1,s0
ffffffffc0203d0e:	00002517          	auipc	a0,0x2
ffffffffc0203d12:	1aa50513          	addi	a0,a0,426 # ffffffffc0205eb8 <default_pmm_manager+0xd90>
ffffffffc0203d16:	ba4fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d1a:	5575                	li	a0,-3
        goto failed;
ffffffffc0203d1c:	b7c1                	j	ffffffffc0203cdc <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d1e:	00002517          	auipc	a0,0x2
ffffffffc0203d22:	1f250513          	addi	a0,a0,498 # ffffffffc0205f10 <default_pmm_manager+0xde8>
ffffffffc0203d26:	b94fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d2a:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d2c:	bf45                	j	ffffffffc0203cdc <do_pgfault+0x7c>

ffffffffc0203d2e <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203d30:	4505                	li	a0,1
swapfs_init(void) {
ffffffffc0203d32:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d34:	f60fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d38:	cd01                	beqz	a0,ffffffffc0203d50 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d3a:	4505                	li	a0,1
ffffffffc0203d3c:	f5efc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d40:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d42:	810d                	srli	a0,a0,0x3
ffffffffc0203d44:	0000d797          	auipc	a5,0xd
ffffffffc0203d48:	7ea7be23          	sd	a0,2044(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203d4c:	0141                	addi	sp,sp,16
ffffffffc0203d4e:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203d50:	00002617          	auipc	a2,0x2
ffffffffc0203d54:	1e860613          	addi	a2,a2,488 # ffffffffc0205f38 <default_pmm_manager+0xe10>
ffffffffc0203d58:	45b5                	li	a1,13
ffffffffc0203d5a:	00002517          	auipc	a0,0x2
ffffffffc0203d5e:	1fe50513          	addi	a0,a0,510 # ffffffffc0205f58 <default_pmm_manager+0xe30>
ffffffffc0203d62:	e12fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d66 <swapfs_read>:
...
ffffffffc0203d6a:	00855793          	srli	a5,a0,0x8
ffffffffc0203d6e:	c3a5                	beqz	a5,ffffffffc0203dce <swapfs_read+0x68>
ffffffffc0203d70:	0000d717          	auipc	a4,0xd
ffffffffc0203d74:	7d073703          	ld	a4,2000(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d78:	04e7fb63          	bgeu	a5,a4,ffffffffc0203dce <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d7c:	0000d617          	auipc	a2,0xd
ffffffffc0203d80:	7ac63603          	ld	a2,1964(a2) # ffffffffc0211528 <pages>
ffffffffc0203d84:	8d91                	sub	a1,a1,a2
ffffffffc0203d86:	4035d613          	srai	a2,a1,0x3
ffffffffc0203d8a:	00002597          	auipc	a1,0x2
ffffffffc0203d8e:	44e5b583          	ld	a1,1102(a1) # ffffffffc02061d8 <error_string+0x38>
ffffffffc0203d92:	02b60633          	mul	a2,a2,a1
ffffffffc0203d96:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d9a:	00002797          	auipc	a5,0x2
ffffffffc0203d9e:	4467b783          	ld	a5,1094(a5) # ffffffffc02061e0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203da2:	0000d717          	auipc	a4,0xd
ffffffffc0203da6:	77e73703          	ld	a4,1918(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203daa:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dac:	00c61793          	slli	a5,a2,0xc
ffffffffc0203db0:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203db2:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203db4:	02e7f963          	bgeu	a5,a4,ffffffffc0203de6 <swapfs_read+0x80>
}
ffffffffc0203db8:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dba:	0000d797          	auipc	a5,0xd
ffffffffc0203dbe:	77e7b783          	ld	a5,1918(a5) # ffffffffc0211538 <va_pa_offset>
...
ffffffffc0203dc8:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dca:	ed6fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203dce:	86aa                	mv	a3,a0
ffffffffc0203dd0:	00002617          	auipc	a2,0x2
ffffffffc0203dd4:	1a060613          	addi	a2,a2,416 # ffffffffc0205f70 <default_pmm_manager+0xe48>
ffffffffc0203dd8:	45d1                	li	a1,20
ffffffffc0203dda:	00002517          	auipc	a0,0x2
ffffffffc0203dde:	17e50513          	addi	a0,a0,382 # ffffffffc0205f58 <default_pmm_manager+0xe30>
...
ffffffffc0203df0:	3cc60613          	addi	a2,a2,972 # ffffffffc02051b8 <default_pmm_manager+0x90>
ffffffffc0203df4:	00001517          	auipc	a0,0x1
ffffffffc0203df8:	38c50513          	addi	a0,a0,908 # ffffffffc0205180 <default_pmm_manager+0x58>
ffffffffc0203dfc:	d78fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e00 <swapfs_write>:
...
ffffffffc0203e04:	00855793          	srli	a5,a0,0x8
ffffffffc0203e08:	c3a5                	beqz	a5,ffffffffc0203e68 <swapfs_write+0x68>
ffffffffc0203e0a:	0000d717          	auipc	a4,0xd
ffffffffc0203e0e:	73673703          	ld	a4,1846(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e12:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e68 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e16:	0000d617          	auipc	a2,0xd
ffffffffc0203e1a:	71263603          	ld	a2,1810(a2) # ffffffffc0211528 <pages>
ffffffffc0203e1e:	8d91                	sub	a1,a1,a2
ffffffffc0203e20:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e24:	00002597          	auipc	a1,0x2
ffffffffc0203e28:	3b45b583          	ld	a1,948(a1) # ffffffffc02061d8 <error_string+0x38>
ffffffffc0203e2c:	02b60633          	mul	a2,a2,a1
ffffffffc0203e30:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e34:	00002797          	auipc	a5,0x2
ffffffffc0203e38:	3ac7b783          	ld	a5,940(a5) # ffffffffc02061e0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e3c:	0000d717          	auipc	a4,0xd
ffffffffc0203e40:	6e473703          	ld	a4,1764(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e44:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e46:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e4a:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e4c:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e4e:	02e7f963          	bgeu	a5,a4,ffffffffc0203e80 <swapfs_write+0x80>
}
ffffffffc0203e52:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e54:	0000d797          	auipc	a5,0xd
ffffffffc0203e58:	6e47b783          	ld	a5,1764(a5) # ffffffffc0211538 <va_pa_offset>
...
ffffffffc0203e62:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e64:	e60fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e68:	86aa                	mv	a3,a0
ffffffffc0203e6a:	00002617          	auipc	a2,0x2
ffffffffc0203e6e:	10660613          	addi	a2,a2,262 # ffffffffc0205f70 <default_pmm_manager+0xe48>
ffffffffc0203e72:	45e5                	li	a1,25
ffffffffc0203e74:	00002517          	auipc	a0,0x2
ffffffffc0203e78:	0e450513          	addi	a0,a0,228 # ffffffffc0205f58 <default_pmm_manager+0xe30>
ffffffffc0203e7c:	cf8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e80:	86b2                	mv	a3,a2
ffffffffc0203e82:	06a00593          	li	a1,106
ffffffffc0203e86:	00001617          	auipc	a2,0x1
ffffffffc0203e8a:	33260613          	addi	a2,a2,818 # ffffffffc02051b8 <default_pmm_manager+0x90>
ffffffffc0203e8e:	00001517          	auipc	a0,0x1
ffffffffc0203e92:	2f250513          	addi	a0,a0,754 # ffffffffc0205180 <default_pmm_manager+0x58>
ffffffffc0203e96:	cdefc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e9a <printnum>:
 * */
static void
...
ffffffffc0203e9a:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e9e:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203ea0:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ea4:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203ea6:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203eaa:	f022                	sd	s0,32(sp)
ffffffffc0203eac:	ec26                	sd	s1,24(sp)
ffffffffc0203eae:	e84a                	sd	s2,16(sp)
ffffffffc0203eb0:	f406                	sd	ra,40(sp)
ffffffffc0203eb2:	e44e                	sd	s3,8(sp)
ffffffffc0203eb4:	84aa                	mv	s1,a0
ffffffffc0203eb6:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203eb8:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203ebc:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203ebe:	03067e63          	bgeu	a2,a6,ffffffffc0203efa <printnum+0x60>
ffffffffc0203ec2:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203ec4:	00805763          	blez	s0,ffffffffc0203ed2 <printnum+0x38>
ffffffffc0203ec8:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203eca:	85ca                	mv	a1,s2
ffffffffc0203ecc:	854e                	mv	a0,s3
ffffffffc0203ece:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203ed0:	fc65                	bnez	s0,ffffffffc0203ec8 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ed2:	1a02                	slli	s4,s4,0x20
ffffffffc0203ed4:	00002797          	auipc	a5,0x2
ffffffffc0203ed8:	0bc78793          	addi	a5,a5,188 # ffffffffc0205f90 <default_pmm_manager+0xe68>
ffffffffc0203edc:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203ee0:	9a3e                	add	s4,s4,a5
}
ffffffffc0203ee2:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ee4:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203ee8:	70a2                	ld	ra,40(sp)
ffffffffc0203eea:	69a2                	ld	s3,8(sp)
ffffffffc0203eec:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203eee:	85ca                	mv	a1,s2
ffffffffc0203ef0:	87a6                	mv	a5,s1
}
ffffffffc0203ef2:	6942                	ld	s2,16(sp)
ffffffffc0203ef4:	64e2                	ld	s1,24(sp)
ffffffffc0203ef6:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ef8:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203efa:	03065633          	divu	a2,a2,a6
ffffffffc0203efe:	8722                	mv	a4,s0
ffffffffc0203f00:	f9bff0ef          	jal	ra,ffffffffc0203e9a <printnum>
ffffffffc0203f04:	b7f9                	j	ffffffffc0203ed2 <printnum+0x38>

ffffffffc0203f06 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f06:	7119                	addi	sp,sp,-128
ffffffffc0203f08:	f4a6                	sd	s1,104(sp)
ffffffffc0203f0a:	f0ca                	sd	s2,96(sp)
ffffffffc0203f0c:	ecce                	sd	s3,88(sp)
ffffffffc0203f0e:	e8d2                	sd	s4,80(sp)
ffffffffc0203f10:	e4d6                	sd	s5,72(sp)
ffffffffc0203f12:	e0da                	sd	s6,64(sp)
ffffffffc0203f14:	fc5e                	sd	s7,56(sp)
ffffffffc0203f16:	f06a                	sd	s10,32(sp)
ffffffffc0203f18:	fc86                	sd	ra,120(sp)
ffffffffc0203f1a:	f8a2                	sd	s0,112(sp)
ffffffffc0203f1c:	f862                	sd	s8,48(sp)
ffffffffc0203f1e:	f466                	sd	s9,40(sp)
ffffffffc0203f20:	ec6e                	sd	s11,24(sp)
ffffffffc0203f22:	892a                	mv	s2,a0
ffffffffc0203f24:	84ae                	mv	s1,a1
ffffffffc0203f26:	8d32                	mv	s10,a2
ffffffffc0203f28:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f2a:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f2e:	5b7d                	li	s6,-1
ffffffffc0203f30:	00002a97          	auipc	s5,0x2
ffffffffc0203f34:	094a8a93          	addi	s5,s5,148 # ffffffffc0205fc4 <default_pmm_manager+0xe9c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f38:	00002b97          	auipc	s7,0x2
ffffffffc0203f3c:	268b8b93          	addi	s7,s7,616 # ffffffffc02061a0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f40:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f44:	001d0413          	addi	s0,s10,1
ffffffffc0203f48:	01350a63          	beq	a0,s3,ffffffffc0203f5c <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f4c:	c121                	beqz	a0,ffffffffc0203f8c <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f4e:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f50:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f52:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f54:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f58:	ff351ae3          	bne	a0,s3,ffffffffc0203f4c <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f5c:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f60:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f64:	4c81                	li	s9,0
ffffffffc0203f66:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f68:	5c7d                	li	s8,-1
ffffffffc0203f6a:	5dfd                	li	s11,-1
ffffffffc0203f6c:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f70:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f72:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f76:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f7a:	00140d13          	addi	s10,s0,1
ffffffffc0203f7e:	04b56263          	bltu	a0,a1,ffffffffc0203fc2 <vprintfmt+0xbc>
ffffffffc0203f82:	058a                	slli	a1,a1,0x2
ffffffffc0203f84:	95d6                	add	a1,a1,s5
ffffffffc0203f86:	4194                	lw	a3,0(a1)
ffffffffc0203f88:	96d6                	add	a3,a3,s5
ffffffffc0203f8a:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203f8c:	70e6                	ld	ra,120(sp)
ffffffffc0203f8e:	7446                	ld	s0,112(sp)
ffffffffc0203f90:	74a6                	ld	s1,104(sp)
ffffffffc0203f92:	7906                	ld	s2,96(sp)
ffffffffc0203f94:	69e6                	ld	s3,88(sp)
ffffffffc0203f96:	6a46                	ld	s4,80(sp)
ffffffffc0203f98:	6aa6                	ld	s5,72(sp)
ffffffffc0203f9a:	6b06                	ld	s6,64(sp)
ffffffffc0203f9c:	7be2                	ld	s7,56(sp)
ffffffffc0203f9e:	7c42                	ld	s8,48(sp)
ffffffffc0203fa0:	7ca2                	ld	s9,40(sp)
ffffffffc0203fa2:	7d02                	ld	s10,32(sp)
ffffffffc0203fa4:	6de2                	ld	s11,24(sp)
ffffffffc0203fa6:	6109                	addi	sp,sp,128
ffffffffc0203fa8:	8082                	ret
            padc = '0';
ffffffffc0203faa:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203fac:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fb0:	846a                	mv	s0,s10
ffffffffc0203fb2:	00140d13          	addi	s10,s0,1
ffffffffc0203fb6:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203fba:	0ff5f593          	zext.b	a1,a1
ffffffffc0203fbe:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f82 <vprintfmt+0x7c>
            putch('%', putdat);
...
ffffffffc0203fce:	8d22                	mv	s10,s0
ffffffffc0203fd0:	f73788e3          	beq	a5,s3,ffffffffc0203f40 <vprintfmt+0x3a>
ffffffffc0203fd4:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203fd8:	1d7d                	addi	s10,s10,-1
ffffffffc0203fda:	ff379de3          	bne	a5,s3,ffffffffc0203fd4 <vprintfmt+0xce>
ffffffffc0203fde:	b78d                	j	ffffffffc0203f40 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203fe0:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203fe4:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fe8:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203fea:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203fee:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203ff2:	02d86463          	bltu	a6,a3,ffffffffc020401a <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203ff6:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203ffa:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203ffe:	0186873b          	addw	a4,a3,s8
ffffffffc0204002:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204006:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204008:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc020400c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020400e:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204012:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204016:	fed870e3          	bgeu	a6,a3,ffffffffc0203ff6 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc020401a:	f40ddce3          	bgez	s11,ffffffffc0203f72 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020401e:	8de2                	mv	s11,s8
ffffffffc0204020:	5c7d                	li	s8,-1
ffffffffc0204022:	bf81                	j	ffffffffc0203f72 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204024:	fffdc693          	not	a3,s11
ffffffffc0204028:	96fd                	srai	a3,a3,0x3f
ffffffffc020402a:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020402e:	00144603          	lbu	a2,1(s0)
ffffffffc0204032:	2d81                	sext.w	s11,s11
ffffffffc0204034:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204036:	bf35                	j	ffffffffc0203f72 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204038:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020403c:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204040:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204042:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204044:	bfd9                	j	ffffffffc020401a <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204046:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204048:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020404c:	01174463          	blt	a4,a7,ffffffffc0204054 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204050:	1a088e63          	beqz	a7,ffffffffc020420c <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204054:	000a3603          	ld	a2,0(s4)
ffffffffc0204058:	46c1                	li	a3,16
ffffffffc020405a:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020405c:	2781                	sext.w	a5,a5
ffffffffc020405e:	876e                	mv	a4,s11
ffffffffc0204060:	85a6                	mv	a1,s1
ffffffffc0204062:	854a                	mv	a0,s2
ffffffffc0204064:	e37ff0ef          	jal	ra,ffffffffc0203e9a <printnum>
            break;
ffffffffc0204068:	bde1                	j	ffffffffc0203f40 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc020406a:	000a2503          	lw	a0,0(s4)
ffffffffc020406e:	85a6                	mv	a1,s1
ffffffffc0204070:	0a21                	addi	s4,s4,8
ffffffffc0204072:	9902                	jalr	s2
            break;
ffffffffc0204074:	b5f1                	j	ffffffffc0203f40 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204076:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204078:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020407c:	01174463          	blt	a4,a7,ffffffffc0204084 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204080:	18088163          	beqz	a7,ffffffffc0204202 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204084:	000a3603          	ld	a2,0(s4)
ffffffffc0204088:	46a9                	li	a3,10
ffffffffc020408a:	8a2e                	mv	s4,a1
ffffffffc020408c:	bfc1                	j	ffffffffc020405c <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020408e:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204092:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204094:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204096:	bdf1                	j	ffffffffc0203f72 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204098:	85a6                	mv	a1,s1
ffffffffc020409a:	02500513          	li	a0,37
ffffffffc020409e:	9902                	jalr	s2
            break;
ffffffffc02040a0:	b545                	j	ffffffffc0203f40 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040a2:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc02040a6:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040a8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040aa:	b5e1                	j	ffffffffc0203f72 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc02040ac:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040ae:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040b2:	01174463          	blt	a4,a7,ffffffffc02040ba <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc02040b6:	14088163          	beqz	a7,ffffffffc02041f8 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc02040ba:	000a3603          	ld	a2,0(s4)
ffffffffc02040be:	46a1                	li	a3,8
ffffffffc02040c0:	8a2e                	mv	s4,a1
ffffffffc02040c2:	bf69                	j	ffffffffc020405c <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02040c4:	03000513          	li	a0,48
ffffffffc02040c8:	85a6                	mv	a1,s1
ffffffffc02040ca:	e03e                	sd	a5,0(sp)
ffffffffc02040cc:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040ce:	85a6                	mv	a1,s1
ffffffffc02040d0:	07800513          	li	a0,120
ffffffffc02040d4:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040d6:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040d8:	6782                	ld	a5,0(sp)
ffffffffc02040da:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040dc:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040e0:	bfb5                	j	ffffffffc020405c <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040e2:	000a3403          	ld	s0,0(s4)
ffffffffc02040e6:	008a0713          	addi	a4,s4,8
ffffffffc02040ea:	e03a                	sd	a4,0(sp)
ffffffffc02040ec:	14040263          	beqz	s0,ffffffffc0204230 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02040f0:	0fb05763          	blez	s11,ffffffffc02041de <vprintfmt+0x2d8>
ffffffffc02040f4:	02d00693          	li	a3,45
ffffffffc02040f8:	0cd79163          	bne	a5,a3,ffffffffc02041ba <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040fc:	00044783          	lbu	a5,0(s0)
ffffffffc0204100:	0007851b          	sext.w	a0,a5
ffffffffc0204104:	cf85                	beqz	a5,ffffffffc020413c <vprintfmt+0x236>
ffffffffc0204106:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020410a:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020410e:	000c4563          	bltz	s8,ffffffffc0204118 <vprintfmt+0x212>
ffffffffc0204112:	3c7d                	addiw	s8,s8,-1
ffffffffc0204114:	036c0263          	beq	s8,s6,ffffffffc0204138 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204118:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020411a:	0e0c8e63          	beqz	s9,ffffffffc0204216 <vprintfmt+0x310>
ffffffffc020411e:	3781                	addiw	a5,a5,-32
ffffffffc0204120:	0ef47b63          	bgeu	s0,a5,ffffffffc0204216 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204124:	03f00513          	li	a0,63
ffffffffc0204128:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020412a:	000a4783          	lbu	a5,0(s4)
ffffffffc020412e:	3dfd                	addiw	s11,s11,-1
ffffffffc0204130:	0a05                	addi	s4,s4,1
ffffffffc0204132:	0007851b          	sext.w	a0,a5
ffffffffc0204136:	ffe1                	bnez	a5,ffffffffc020410e <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204138:	01b05963          	blez	s11,ffffffffc020414a <vprintfmt+0x244>
ffffffffc020413c:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc020413e:	85a6                	mv	a1,s1
ffffffffc0204140:	02000513          	li	a0,32
ffffffffc0204144:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204146:	fe0d9be3          	bnez	s11,ffffffffc020413c <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020414a:	6a02                	ld	s4,0(sp)
ffffffffc020414c:	bbd5                	j	ffffffffc0203f40 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020414e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204150:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204154:	01174463          	blt	a4,a7,ffffffffc020415c <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204158:	08088d63          	beqz	a7,ffffffffc02041f2 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc020415c:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204160:	0a044d63          	bltz	s0,ffffffffc020421a <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204164:	8622                	mv	a2,s0
ffffffffc0204166:	8a66                	mv	s4,s9
ffffffffc0204168:	46a9                	li	a3,10
ffffffffc020416a:	bdcd                	j	ffffffffc020405c <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc020416c:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204170:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204172:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204174:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204178:	8fb5                	xor	a5,a5,a3
ffffffffc020417a:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020417e:	02d74163          	blt	a4,a3,ffffffffc02041a0 <vprintfmt+0x29a>
ffffffffc0204182:	00369793          	slli	a5,a3,0x3
ffffffffc0204186:	97de                	add	a5,a5,s7
ffffffffc0204188:	639c                	ld	a5,0(a5)
ffffffffc020418a:	cb99                	beqz	a5,ffffffffc02041a0 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020418c:	86be                	mv	a3,a5
ffffffffc020418e:	00002617          	auipc	a2,0x2
ffffffffc0204192:	e3260613          	addi	a2,a2,-462 # ffffffffc0205fc0 <default_pmm_manager+0xe98>
ffffffffc0204196:	85a6                	mv	a1,s1
ffffffffc0204198:	854a                	mv	a0,s2
ffffffffc020419a:	0ce000ef          	jal	ra,ffffffffc0204268 <printfmt>
ffffffffc020419e:	b34d                	j	ffffffffc0203f40 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc02041a0:	00002617          	auipc	a2,0x2
ffffffffc02041a4:	e1060613          	addi	a2,a2,-496 # ffffffffc0205fb0 <default_pmm_manager+0xe88>
ffffffffc02041a8:	85a6                	mv	a1,s1
ffffffffc02041aa:	854a                	mv	a0,s2
ffffffffc02041ac:	0bc000ef          	jal	ra,ffffffffc0204268 <printfmt>
ffffffffc02041b0:	bb41                	j	ffffffffc0203f40 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02041b2:	00002417          	auipc	s0,0x2
ffffffffc02041b6:	df640413          	addi	s0,s0,-522 # ffffffffc0205fa8 <default_pmm_manager+0xe80>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041ba:	85e2                	mv	a1,s8
ffffffffc02041bc:	8522                	mv	a0,s0
ffffffffc02041be:	e43e                	sd	a5,8(sp)
ffffffffc02041c0:	196000ef          	jal	ra,ffffffffc0204356 <strnlen>
ffffffffc02041c4:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041c8:	01b05b63          	blez	s11,ffffffffc02041de <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041cc:	67a2                	ld	a5,8(sp)
ffffffffc02041ce:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041d2:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02041d4:	85a6                	mv	a1,s1
ffffffffc02041d6:	8552                	mv	a0,s4
ffffffffc02041d8:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041da:	fe0d9ce3          	bnez	s11,ffffffffc02041d2 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041de:	00044783          	lbu	a5,0(s0)
ffffffffc02041e2:	00140a13          	addi	s4,s0,1
ffffffffc02041e6:	0007851b          	sext.w	a0,a5
ffffffffc02041ea:	d3a5                	beqz	a5,ffffffffc020414a <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041ec:	05e00413          	li	s0,94
ffffffffc02041f0:	bf39                	j	ffffffffc020410e <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02041f2:	000a2403          	lw	s0,0(s4)
ffffffffc02041f6:	b7ad                	j	ffffffffc0204160 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02041f8:	000a6603          	lwu	a2,0(s4)
ffffffffc02041fc:	46a1                	li	a3,8
ffffffffc02041fe:	8a2e                	mv	s4,a1
ffffffffc0204200:	bdb1                	j	ffffffffc020405c <vprintfmt+0x156>
ffffffffc0204202:	000a6603          	lwu	a2,0(s4)
ffffffffc0204206:	46a9                	li	a3,10
ffffffffc0204208:	8a2e                	mv	s4,a1
ffffffffc020420a:	bd89                	j	ffffffffc020405c <vprintfmt+0x156>
ffffffffc020420c:	000a6603          	lwu	a2,0(s4)
ffffffffc0204210:	46c1                	li	a3,16
ffffffffc0204212:	8a2e                	mv	s4,a1
ffffffffc0204214:	b5a1                	j	ffffffffc020405c <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204216:	9902                	jalr	s2
ffffffffc0204218:	bf09                	j	ffffffffc020412a <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc020421a:	85a6                	mv	a1,s1
ffffffffc020421c:	02d00513          	li	a0,45
ffffffffc0204220:	e03e                	sd	a5,0(sp)
ffffffffc0204222:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204224:	6782                	ld	a5,0(sp)
ffffffffc0204226:	8a66                	mv	s4,s9
ffffffffc0204228:	40800633          	neg	a2,s0
ffffffffc020422c:	46a9                	li	a3,10
ffffffffc020422e:	b53d                	j	ffffffffc020405c <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204230:	03b05163          	blez	s11,ffffffffc0204252 <vprintfmt+0x34c>
ffffffffc0204234:	02d00693          	li	a3,45
ffffffffc0204238:	f6d79de3          	bne	a5,a3,ffffffffc02041b2 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc020423c:	00002417          	auipc	s0,0x2
ffffffffc0204240:	d6c40413          	addi	s0,s0,-660 # ffffffffc0205fa8 <default_pmm_manager+0xe80>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204244:	02800793          	li	a5,40
ffffffffc0204248:	02800513          	li	a0,40
ffffffffc020424c:	00140a13          	addi	s4,s0,1
ffffffffc0204250:	bd6d                	j	ffffffffc020410a <vprintfmt+0x204>
ffffffffc0204252:	00002a17          	auipc	s4,0x2
ffffffffc0204256:	d57a0a13          	addi	s4,s4,-681 # ffffffffc0205fa9 <default_pmm_manager+0xe81>
ffffffffc020425a:	02800513          	li	a0,40
ffffffffc020425e:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204262:	05e00413          	li	s0,94
ffffffffc0204266:	b565                	j	ffffffffc020410e <vprintfmt+0x208>

ffffffffc0204268 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204268:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020426a:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020426e:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204270:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204272:	ec06                	sd	ra,24(sp)
ffffffffc0204274:	f83a                	sd	a4,48(sp)
ffffffffc0204276:	fc3e                	sd	a5,56(sp)
ffffffffc0204278:	e0c2                	sd	a6,64(sp)
ffffffffc020427a:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020427c:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020427e:	c89ff0ef          	jal	ra,ffffffffc0203f06 <vprintfmt>
}
ffffffffc0204282:	60e2                	ld	ra,24(sp)
ffffffffc0204284:	6161                	addi	sp,sp,80
ffffffffc0204286:	8082                	ret

ffffffffc0204288 <readline>:
...
ffffffffc0204288:	715d                	addi	sp,sp,-80
ffffffffc020428a:	e486                	sd	ra,72(sp)
ffffffffc020428c:	e0a6                	sd	s1,64(sp)
ffffffffc020428e:	fc4a                	sd	s2,56(sp)
ffffffffc0204290:	f84e                	sd	s3,48(sp)
ffffffffc0204292:	f452                	sd	s4,40(sp)
ffffffffc0204294:	f056                	sd	s5,32(sp)
ffffffffc0204296:	ec5a                	sd	s6,24(sp)
ffffffffc0204298:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc020429a:	c901                	beqz	a0,ffffffffc02042aa <readline+0x22>
ffffffffc020429c:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc020429e:	00002517          	auipc	a0,0x2
ffffffffc02042a2:	d2250513          	addi	a0,a0,-734 # ffffffffc0205fc0 <default_pmm_manager+0xe98>
ffffffffc02042a6:	e15fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc02042aa:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc02042ac:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc02042ae:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc02042b0:	4aa9                	li	s5,10
ffffffffc02042b2:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc02042b4:	0000db97          	auipc	s7,0xd
ffffffffc02042b8:	e44b8b93          	addi	s7,s7,-444 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042bc:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042c0:	e33fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042c4:	00054a63          	bltz	a0,ffffffffc02042d8 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042c8:	00a95a63          	bge	s2,a0,ffffffffc02042dc <readline+0x54>
ffffffffc02042cc:	029a5263          	bge	s4,s1,ffffffffc02042f0 <readline+0x68>
        c = getchar();
ffffffffc02042d0:	e23fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042d4:	fe055ae3          	bgez	a0,ffffffffc02042c8 <readline+0x40>
            return NULL;
ffffffffc02042d8:	4501                	li	a0,0
ffffffffc02042da:	a091                	j	ffffffffc020431e <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042dc:	03351463          	bne	a0,s3,ffffffffc0204304 <readline+0x7c>
ffffffffc02042e0:	e8a9                	bnez	s1,ffffffffc0204332 <readline+0xaa>
        c = getchar();
ffffffffc02042e2:	e11fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042e6:	fe0549e3          	bltz	a0,ffffffffc02042d8 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042ea:	fea959e3          	bge	s2,a0,ffffffffc02042dc <readline+0x54>
...
ffffffffc02042fc:	2485                	addiw	s1,s1,1
ffffffffc02042fe:	00a78023          	sb	a0,0(a5)
ffffffffc0204302:	bf7d                	j	ffffffffc02042c0 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc0204304:	01550463          	beq	a0,s5,ffffffffc020430c <readline+0x84>
ffffffffc0204308:	fb651ce3          	bne	a0,s6,ffffffffc02042c0 <readline+0x38>
            cputchar(c);
ffffffffc020430c:	de5fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc0204310:	0000d517          	auipc	a0,0xd
ffffffffc0204314:	de850513          	addi	a0,a0,-536 # ffffffffc02110f8 <buf>
...
ffffffffc0204320:	6486                	ld	s1,64(sp)
ffffffffc0204322:	7962                	ld	s2,56(sp)
ffffffffc0204324:	79c2                	ld	s3,48(sp)
ffffffffc0204326:	7a22                	ld	s4,40(sp)
ffffffffc0204328:	7a82                	ld	s5,32(sp)
ffffffffc020432a:	6b62                	ld	s6,24(sp)
ffffffffc020432c:	6bc2                	ld	s7,16(sp)
ffffffffc020432e:	6161                	addi	sp,sp,80
ffffffffc0204330:	8082                	ret
            cputchar(c);
ffffffffc0204332:	4521                	li	a0,8
ffffffffc0204334:	dbdfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204338:	34fd                	addiw	s1,s1,-1
ffffffffc020433a:	b759                	j	ffffffffc02042c0 <readline+0x38>

ffffffffc020433c <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc020433c:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204340:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204342:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204344:	cb81                	beqz	a5,ffffffffc0204354 <strlen+0x18>
        cnt ++;
ffffffffc0204346:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204348:	00a707b3          	add	a5,a4,a0
ffffffffc020434c:	0007c783          	lbu	a5,0(a5)
ffffffffc0204350:	fbfd                	bnez	a5,ffffffffc0204346 <strlen+0xa>
...
ffffffffc0204356:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204358:	e589                	bnez	a1,ffffffffc0204362 <strnlen+0xc>
ffffffffc020435a:	a811                	j	ffffffffc020436e <strnlen+0x18>
        cnt ++;
ffffffffc020435c:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020435e:	00f58863          	beq	a1,a5,ffffffffc020436e <strnlen+0x18>
ffffffffc0204362:	00f50733          	add	a4,a0,a5
ffffffffc0204366:	00074703          	lbu	a4,0(a4)
ffffffffc020436a:	fb6d                	bnez	a4,ffffffffc020435c <strnlen+0x6>
ffffffffc020436c:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020436e:	852e                	mv	a0,a1
ffffffffc0204370:	8082                	ret

ffffffffc0204372 <strcpy>:
char *
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204384:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204388:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020438c:	cb89                	beqz	a5,ffffffffc020439e <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020438e:	0505                	addi	a0,a0,1
ffffffffc0204390:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204392:	fee789e3          	beq	a5,a4,ffffffffc0204384 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204396:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc020439a:	9d19                	subw	a0,a0,a4
ffffffffc020439c:	8082                	ret
ffffffffc020439e:	4501                	li	a0,0
ffffffffc02043a0:	bfed                	j	ffffffffc020439a <strcmp+0x16>

ffffffffc02043a2 <strchr>:
...
ffffffffc02043a6:	c799                	beqz	a5,ffffffffc02043b4 <strchr+0x12>
        if (*s == c) {
ffffffffc02043a8:	00f58763          	beq	a1,a5,ffffffffc02043b6 <strchr+0x14>
    while (*s != '\0') {
ffffffffc02043ac:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02043b0:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02043b2:	fbfd                	bnez	a5,ffffffffc02043a8 <strchr+0x6>
    }
    return NULL;
ffffffffc02043b4:	4501                	li	a0,0
}
ffffffffc02043b6:	8082                	ret

ffffffffc02043b8 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02043b8:	ca01                	beqz	a2,ffffffffc02043c8 <memset+0x10>
ffffffffc02043ba:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02043bc:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02043be:	0785                	addi	a5,a5,1
ffffffffc02043c0:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02043c4:	fec79de3          	bne	a5,a2,ffffffffc02043be <memset+0x6>
    }
    return s;
...
ffffffffc02043ca <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043ca:	ca19                	beqz	a2,ffffffffc02043e0 <memcpy+0x16>
ffffffffc02043cc:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043ce:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043d0:	0005c703          	lbu	a4,0(a1)
ffffffffc02043d4:	0585                	addi	a1,a1,1
ffffffffc02043d6:	0785                	addi	a5,a5,1
ffffffffc02043d8:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043dc:	fec59ae3          	bne	a1,a2,ffffffffc02043d0 <memcpy+0x6>
    }
    return dst;
